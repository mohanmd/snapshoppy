...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'customer/getbestprice')) {		
			$customer[] = array(
					'name'	   => 'Get Best Price',
					'href'     => $this->url->link('customer/getbestprice', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			
			if ($this->user->hasPermission('access', 'customer/holesaleprice')) {		
			$customer[] = array(
					'name'	   => 'Get Holesale Price',
					'href'     => $this->url->link('customer/holesaleprice', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
