...
class ModelCustomerCustomer extends Model {
	...
	public function getTotalgetbestprice($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM getbestprice";
		...
		if (!empty($data['filter_emailid'])) {
			$implode[] = "emailid LIKE '" . $this->db->escape($data['filter_emailid']) . "%'";
		}

	


		if (isset($data['filter_readstatus']) && $data['filter_readstatus'] !== '') {
			$implode[] = "readstatus = '" . (int)$data['filter_readstatus'] . "'";
		}
	...
	public function getBestprice($data = array()) {
		$sql = "SELECT c.*,p.name as pname FROM getbestprice c LEFT join oc_product_description p on p.product_id=c.product_id";
		...
		if (!empty($data['filter_email'])) {
			$implode[] = "c.emailid LIKE '" . $this->db->escape($data['filter_email']) . "%'";
		}


		
	//	if (isset($data['filter_readstatus']) && $data['filter_readstatus'] !== '') {
	//		$implode[] = "c.readstatus = '" . (int)$data['filter_readstatus'] . "'";
	//	}
	...
	public function getTotalgetholesaleprice($data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM getholesaleprice";
	...
	public function getholesaleprice($data = array()) {
		$sql = "SELECT c.*,p.name as pname FROM getholesaleprice c LEFT join oc_product_description p on p.product_id=c.product_id";
