...
<div itemscope itemtype="http://schema.org/Product">
  ...
  <div class="product-info">
  	<div class="row">
  	     <center><a target="_blank" href="https://kuberthemes.com/topic/92-how-to-install-opencart-kiaria-theme/"><b><u>Theme Installation Error: Delete Cache or Re-Download and re-upload or DOWNLOAD LATEST VERSION OF KIARIA THEME Click here</u></b></a></center>
			      ...
			      <div class="cart">
			        ...
			        <div class="links clearfix">
                       ...
                       <li><i class="fa fa-heart-o"></i> <a onclick="wishlist.add('<?php echo $product_id; ?>');"><?php if($theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_wishlist_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to wishlist'; } ?></a></li>
			        	<li><i class="fa fa-refresh"></i><a onclick="compare.add('<?php echo $product_id; ?>');"><?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?></a></li></ul>
			        </div>
